...
module.exports.userDetails = async (request, response) => {
    try {
        ...
        // Calculate team turnover including all downline deposits
        const teamMembers = await getAllTeamMembers(userExists._id);
        teamMembers.push(userExists._id); // Include user's own deposits
        ...
        // Calculate total rewards from all reward types
        ...
        return response.status(200).json({
            ...
            data: {
                ...
                totalTeamTurnoverBalance: teamTurnover.length > 0 ? teamTurnover[0].total : 0,
                totalTeam: totalTeam,
                totalRewardBalance: totalRewards.length > 0 ? totalRewards[0].total : 0,
                level: userExists.level,
                totalStakedBalance: stakedBalance.length > 0 ? stakedBalance[0].total : 0,
...
module.exports.updateUser = async (request, response) => {
    try {
        ...
        BUSDBalance !== undefined && (userData.BUSDBalance = BUSDBalance);
        bonusBalance !== undefined && (userData.bonusBalance = bonusBalance);
        totalStakedBalance !== undefined && (userData.totalStakedBalance = totalStakedBalance);
        totalWithdrawalBalance !== undefined && (userData.totalWithdrawalBalance = totalWithdrawalBalance);
        totalTeamTurnoverBalance !== undefined && (userData.totalTeamTurnoverBalance = totalTeamTurnoverBalance);
        totalDirectTeamTurnoverBalance !== undefined && (userData.totalDirectTeamTurnoverBalance = totalDirectTeamTurnoverBalance);
        totalRemovedStakedBalance !== undefined && (userData.totalRemovedStakedBalance = totalRemovedStakedBalance);
        TRADEBalance !== undefined && (userData.TRADEBalance = TRADEBalance);
        totalDelegateRewardBalance !== undefined && (userData.totalDelegateRewardBalance = totalDelegateRewardBalance);
        totalUnlockRewardBalnce !== undefined && (userData.totalUnlockRewardBalnce = totalUnlockRewardBalnce);
        totalReferralRewardBalance !== undefined && (userData.totalReferralRewardBalance = totalReferralRewardBalance);
        totalStakingRewardBalance !== undefined && (userData.totalStakingRewardBalance = totalStakingRewardBalance);
        totalRankBonusBalance !== undefined && (userData.totalRankBonusBalance = totalRankBonusBalance);
        totalRewardBalance !== undefined && (userData.totalRewardBalance = totalRewardBalance);
