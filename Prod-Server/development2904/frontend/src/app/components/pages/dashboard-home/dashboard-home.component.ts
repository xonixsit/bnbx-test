  ...
  getProfileInfo(): void {
    ...
    this.authService.getProfile(this.token).subscribe({
      next: (response) => {
        ...
        this.totalInternalTransferBalance = response.data.tradeWalletBalance
        ...
        this.totalTeamTurnover = response.data.totalTeamTurnover
        this.bondBalance = response.data.totalStakingRewardBalance
        this.bonusBalance = response.data.totalBonusBalance
