...
const calculateUserBalance = async (userId) => {
    ...
    try {
        ...
        const referralWithdrawalsTotal = Number((referralWithdrawals.length > 0 ? referralWithdrawals[0].total : 0).toFixed(2));
        console.log('referralWithdrawalsTotal',referralWithdrawalsTotal);
        const availableReferralBalance = Math.max(0, (Number(totalReferral - totalReferralStaked).toFixed(2)) - referralWithdrawalsTotal);
        ...
        const tradeWalletBalance = Math.max(0,(mainToTradeTransactions.length > 0? mainToTradeTransactions[0].total : 0) -
        ...
        return {
            ...
            totalReferralRewardBalance: availableReferralBalance,
            ...
            tradeWalletBalance: tradeWalletBalance,
            ...
            components: {
                ...
                balances: {
                    referral: referralWithdrawalsTotal,
